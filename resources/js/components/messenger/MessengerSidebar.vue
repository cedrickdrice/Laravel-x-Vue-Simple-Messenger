<template>
    <div id="sidepanel">
        ...
        <messenger-contacts :oLoggedUser="oLoggedUser" :oSelectedUser="oSelectedUser"></messenger-contacts>
    ...
    export default {
        ...
        computed: {
            ...mapState({
                ...
                oSearchUserList     : state => state.chats.searchUserList,
            })
        },
        methods: {
            ...mapMutations(['fetchSearchedUserList']),
            ...mapActions([
                'getUserListFromSearch',
            ]),
            ...
            /**
             * Select Chat from Previous chat list
             * @param oUser
             */
            ...
            /**
             * On keypress, search user by name or email
             * @param oEvent
             * @returns {boolean}
             */
            doSearchUser: function (oEvent) {
                ...
                if (sKeyword.length <= 3) {
                    this.fetchSearchedUserList([]);
                    this.bShowUserSearch = true;
                    return false;
                }
                const oForm = { search: sKeyword };
                this.getUserListFromSearch(oForm);
            }
        },
    }
</script>
